...
namespace SupportAIO.Champions
{
    class Zyra : Champion
    {
        ...
        protected override void SetSpells()
        {
            ...
            Q.SetSkillshot(0.85f, 140f, 3000, false, SkillshotType.Line);
            W.SetSkillshot(0.25f, 150, 1000f, false, SkillshotType.Circle);
            E.SetSkillshot(0.25f, 60, 1300f,  false, SkillshotType.Line);
