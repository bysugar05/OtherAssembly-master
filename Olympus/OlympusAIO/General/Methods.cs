    ...
    class Methods
    {
        ...
        public static void OnLoad()
        {
            Game.OnWndProc += delegate (GameWndProcEventArgs args)
            {
                ...
                {
                    Hacks.DisableAntiDisconnect = true; DisableAntiDC = true;
                }
                else if (!OlympusAIO.MainMenu["DisableAntiDC"].GetValue<MenuBool>().Enabled && DisableAntiDC)
                {
                    Hacks.DisableAntiDisconnect = false; DisableAntiDC = false;
                }
            };
            ...
            Orbwalker.OnAction += delegate (object sender, OrbwalkerActionArgs args)
            {
