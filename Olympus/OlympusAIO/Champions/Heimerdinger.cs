...
namespace OlympusAIO.Champions
{
    class Heimerdinger
    {
        ...
        public static void OnLoad()
        {
            ...
            SpellManager.Q.SetSkillshot(05f, 400f, 1450f, false, SkillshotType.Circle);

            SpellManager.W = new Spell(SpellSlot.W, 1325f);
            SpellManager.W.SetSkillshot(0.5f, 100f, 750f, true, SkillshotType.Line);

            SpellManager.E = new Spell(SpellSlot.E, 970f);
            SpellManager.E.SetSkillshot(0.5f, 100f, 1200f, false, SkillshotType.Circle);
